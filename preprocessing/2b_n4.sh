"""
    ...
    1. chmod +x 2b_n4.sh 
    2. /home/projects/brain-mri-processing-pipeline/main_pipeline/2b_n4.sh
    
    with docker image cbica/captk:latest:
    docker run -it --rm --cpuset-cpus='0-15' -v /anvar/public_datasets/preproc_study/gbm/2a_interp/:/input -v /anvar/public_datasets/preproc_study/gbm/2b_n4/:/output -v ${PWD}:/home --entrypoint /bin/bash cbica/captk:latest
