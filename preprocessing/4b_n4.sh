"""
    ...
    docker run -it --rm --cpuset-cpus='0-15' -v /anvar/public_datasets/preproc_study/lgg/4a_resamp/:/input -v /anvar/public_datasets/preproc_study/lgg/4b_n4/:/output -v ${PWD}:/home --entrypoint /bin/bash cbica/captk:latest
