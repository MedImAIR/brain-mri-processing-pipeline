"""
    ...
    docker run -it --rm --cpuset-cpus='0-15' -v /anvar/public_datasets/preproc_study/gbm/4a_resamp/:/input -v /anvar/public_datasets/preproc_study/gbm/4d_susan/:/output -v ${PWD}:/home --entrypoint /bin/bash cbica/captk:latest
