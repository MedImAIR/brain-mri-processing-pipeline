"""
    ...
    2. /home/projects/brain-mri-processing-pipeline/main_pipeline/3c_n4_susan.sh
    
    with docker image cbica/captk:latest:
    docker run -it --rm --cpuset-cpus='0-15' -v /anvar/public_datasets/preproc_study/gbm/3a_atlas/:/input -v /anvar/public_datasets/preproc_study/gbm/3c_n4_susan/:/output -v ${PWD}:/home --entrypoint /bin/bash cbica/captk:latest
