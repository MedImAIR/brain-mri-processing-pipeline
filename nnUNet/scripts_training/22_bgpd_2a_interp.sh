...
# --resume_training --ckpt_path /results/bgpd_results/$name/fold-0/checkpoints/last.ckpt 
export CUDA_VISIBLE_DEVICES=0 && python3 ../main.py --no_back_in_output --data /data/private_data/${task}_3d --results /results/bgpd_results/$name/fold-0 --deep_supervision --depth 6 --filters 64 96 128 192 256 384 512 --min_fmap 2 --scheduler --learning_rate 0.0003 --epochs 70 --nfolds 3 --fold 0 --amp --gpus 1 --task $task --patience 20 --save_ckpt 
...
export CUDA_VISIBLE_DEVICES=1 && python3 ../main.py --no_back_in_output --data /data/private_data/${task}_3d --results /results/bgpd_results/$name/fold-1 --deep_supervision --depth 6 --filters 64 96 128 192 256 384 512 --min_fmap 2 --scheduler --learning_rate 0.0003 --epochs 70 --nfolds 3 --fold 1 --amp --gpus 1 --task $task --patience 20 --save_ckpt
