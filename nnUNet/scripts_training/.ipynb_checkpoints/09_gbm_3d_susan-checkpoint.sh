...
export CUDA_VISIBLE_DEVICES=1 && python3 ../main.py --brats --data /data/private_data/{$task}_3d --results /results/gbm_results/$name/fold-0 --deep_supervision --depth 6 --filters 64 96 128 192 256 384 512 --min_fmap 2 --scheduler --learning_rate 0.0003 --epochs 100 --nfolds 3 --fold 0 --amp --gpus 1 --task $task --save_ckpt
...
export CUDA_VISIBLE_DEVICES=1 && python3 ../main.py --brats --data /data/private_data/{$task}_3d --results /results/gbm_results/$name/fold-2 --deep_supervision --depth 6 --filters 64 96 128 192 256 384 512 --min_fmap 2 --scheduler --learning_rate 0.0003 --epochs 100 --nfolds 3 --fold 2 --amp --gpus 1 --task $task --save_ckpt
...
python metrics.py --path_to_pred /results/gbm_infer/$name/*fold=0_tta --path_to_target  /data/private_data/gbm_{$name}/labels --out /results/gbm_infer/$name/metrics_gbm_{$name}_fold-0.csv
...
python metrics.py --path_to_pred /results/gbm_infer/$name/*fold=1_tta --path_to_target  /data/private_data/gbm_{$name}/labels --out /results/gbm_infer/$name/metrics_gbm_{$name}_fold-1.csv
...
python metrics.py --path_to_pred /results/gbm_infer/$name/*fold=2_tta --path_to_target  /data/private_data/gbm_$name/labels --out /results/gbm_infer/$name/metrics_gbm_{$name}_fold-2.csv