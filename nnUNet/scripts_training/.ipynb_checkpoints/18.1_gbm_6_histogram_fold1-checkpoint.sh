...
python metrics.py --path_to_pred /results/gbm_infer/$name/*fold=1_tta --path_to_target   /data_anvar/public_datasets/preproc_study/gbm/6_hist/$name/labels --out /results/gbm_infer/$name/metrics_gbm_${name}_fold-1.csv
