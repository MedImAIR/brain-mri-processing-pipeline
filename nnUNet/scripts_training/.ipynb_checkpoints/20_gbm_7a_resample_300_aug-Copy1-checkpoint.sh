...
# python metrics.py --path_to_pred /results/gbm_infer/$name/*fold=0_tta --path_to_target  /data/private_data/7a_resample/labels --out /results/gbm_infer/$name/metrics_gbm_${name}_fold-0.csv
...
python metrics.py --path_to_pred /results/gbm_infer/$name/*fold=1_tta --path_to_target  /data/private_data/7a_resample/labels --out /results/gbm_infer/$name/metrics_gbm_${name}_fold-1.csv
...
# python metrics.py --path_to_pred /results/gbm_infer/$name/*fold=2_tta --path_to_target  /data/private_data/7a_resample/labels --out /results/gbm_infer/$name/metrics_gbm_${name}_fold-2.csv
