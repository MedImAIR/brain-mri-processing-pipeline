...
name='schw_4a_resamp'
dataset='schw'
python3 ../preprocess.py --data /data/private_data/schw/ --task $task --ohe --exec_mode training --results /data/private_data/schw/
...
export CUDA_VISIBLE_DEVICES=1 && python3 ../main.py --exec_mode predict --task ${task}_3d --data /data/private_data/${dataset}/${task}_3d --no_back_in_output --dim 3 --fold 0 --nfolds 3 --ckpt_path /results/${dataset}_results/$name/fold-0/checkpoints/best*.ckpt --results /results/${dataset}_infer/$name --amp --tta --save_preds
