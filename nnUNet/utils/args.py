...
def get_main_args(strings=None):
    ...
    arg("--freeze",action="store_true", help="Freeze layers for TL" )
    arg("--no_back_in_output", action="store_true", help="Enable specific training and inference")
    arg("--unetr", action="store_true", help="Enable Unetr architecture")
    arg("--train_inf", action="store_true", help="Enable specific inference")
