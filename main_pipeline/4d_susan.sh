"""
    ...
    1. chmod +x /home/projects/brain-mri-processing-pipeline/main_pipeline/4d_susan.sh
    2. /home/projects/brain-mri-processing-pipeline/main_pipeline/4d_susan.sh
    
    with docker image cbica/captk:latest:
    docker run -it --rm --cpuset-cpus='0-15' -v /anvar/public_datasets/preproc_study/schw/4a_resamp/:/input -v /anvar/public_datasets/preproc_study/schw/4d_susan/:/output -v ${PWD}:/home --entrypoint /bin/bash cbica/captk:latest
